...
export default function Home() {
  ...
  const showPageRail = appReady && view !== "home" && view !== "result";
  ...
  return (
    <main className={`app-shell ${showPageRail ? "" : "no-page-rail"}`}>
      ...
      {showPageRail && <PageRail view={view} cardCount={personalCards.length} />}
...
function PageRail({ view, cardCount }: { view: View; cardCount: number }) {
  if (view === "activity") {
