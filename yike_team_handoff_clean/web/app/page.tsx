...
function PageRail({ view, cardCount, context, contextSummary, ambient, petalBalance, petalLedger, onRefreshAmbient, setContext, onNavigate }: {
  ...
  if (view === "add") {
    return <aside className="desktop-context page-rail capture-rail"><div className="context-title"><span>先交给小宜</span><b>3 STEPS</b></div><ol className="capture-steps"><li><b>1</b><div><strong>先认一认</strong><span>找出标题、类别和内容线索</span></div></li><li><b>2</b><div><strong>再补一补</strong><span>估一估需要的时间、力气和准备</span></div></li><li><b>3</b><div><strong>你点头后再收好</strong><span>确认合适，再放进你的心动收藏夹</span></div></li></ol><img className="rail-otter" src="/art/yike/otter-companion.webp" alt="拿着花种的小宜" /><div className="rail-note privacy"><strong>图片仅用于本次整理</strong><span>原图默认私有，不会公开展示。</span></div></aside>;
  }
  if (view === "achievements") {
    return <AchievementRail petalBalance={petalBalance} petalLedger={petalLedger} onNavigate={onNavigate} />;
  }
  return <aside className="desktop-context page-rail memory-rail"><div className="context-title"><span>只陪你过今晚的事</span><b>PRIVATE</b></div><img className="rail-shell memory-care-otter" src="/art/yike/otter-period-care.png" alt="抱着热水袋的小宜" /><h2>有些小状况，小宜只在今晚记得</h2><ul><li>经期不舒服</li><li>不想久站</li><li>不想费心打扮</li></ul><p>这些只用来照顾当下，不会被写成长期偏好，也不会被拿来猜测你的身体或性格。</p><div className="rail-note privacy"><strong>这些记忆都由你做主</strong><span>看得到、改得了、删得掉，也可以全部清空。</span></div></aside>;
}
